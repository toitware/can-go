...
import (
	...
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/definitiontypeorder"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/intervals"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/lineendings"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/messagenames"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/multiplexedsignals"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/newsymbols"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/nodereferences"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/noreservedsignals"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/requireddefinitions"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/signalbounds"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/signalnames"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/singletondefinitions"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/siunits"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/uniquenodenames"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/uniquesignalnames"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/unitsuffixes"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/valuedescriptions"
	"github.com/toitware/can-go/pkg/dbc/analysis/passes/version"
