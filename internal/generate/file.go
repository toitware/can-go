...
func Imports(f *File) {
	...
	f.P(`"time"`)
	f.P()
	f.P(`"github.com/toitware/can-go"`)
	f.P(`"github.com/toitware/can-go/pkg/socketcan"`)
	f.P(`"github.com/toitware/can-go/pkg/candebug"`)
	f.P(`"github.com/toitware/can-go/pkg/canrunner"`)
	f.P(`"github.com/toitware/can-go/pkg/descriptor"`)
	f.P(`"github.com/toitware/can-go/pkg/generated"`)
	f.P(`"github.com/toitware/can-go/pkg/cantext"`)
	f.P(")")
	f.P()
